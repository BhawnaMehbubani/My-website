...
export default function ExperienceCard({}: Props) {
  return (
    <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[300px] md:w-[500px] xl:w-[900px] snap-center bg-[#292929] p-10 ml-40 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-auto ">
        <motion.img 
            initial={{
                y:-100,
                opacity:0,
        ...
        className="w-20 h-20 rounded-full mt-20 xl:w-[80px] xl:h-[80px] object-cover object-center"
        ...
        />
            ...
            <div className="px-0 md:px-0">
                ...
                <div className="flex space-x-2 my-2">
                    ...
                    <img 
                    className="h-10 w-10 rounded-full"
                    src="https://cdn.icon-icons.com/icons2/2699/PNG/512/atlassian_jira_logo_icon_170511.png" alt=""
                    />
                    {/*Tech Used*/}
                    {/*Tech Used*/}
                    {/*Tech Used*/}
                ...
                <p className="uppercase py-5 text-gray-300">
                    19th July 2022- present
                </p>
                <ul className="list-disc space-y-1 ml-5 text-lg">
                    <li>Wrote clear and clean code for use in projects </li>
                    <li>Utilized a wide range of development tools, including Selenium with JAVA, TestNG, Apache POI, SoapUI, BDD Framework viz. Cucumber, and Agile.  </li>
                    <li>Authored and maintained test cases and scripts for both manual ad automated testing</li>
                    <li>Worked with Agile and Scrum methodologies to accomplish project milestones and meet demanding timelines </li>
                </ul>
